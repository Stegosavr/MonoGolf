...
namespace Snakedy
{
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            Console.WriteLine(Ball.Bounds.Intersects(Block.Bounds));
        ...
        //    Borders[0]=(new Border(this, new RectangleF(0, 0, screenWidth, 100)));
        //    Borders[1]=(new Border(this, new RectangleF(0, screenHeight, screenWidth, 100)));
        //    Borders[2]=(new Border(this, new RectangleF(0, 0, 1, screenHeight)));
        //    Borders[3]=(new Border(this, new RectangleF(screenWidth, 0, 1, screenHeight)));
